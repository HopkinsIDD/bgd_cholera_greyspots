...
km_vec_ls <- list(B1= c(10, 20, 30, 30), B2 = c(10, 10, 30, 30), B3 = c(20, 20, 30, 30), B4 = c(15, 25, 35, 30)) 
...
for(i in 1:length(km_vec_ls)){
  ...
  hosp_dat2 <- hosp_dat %>%  
    dplyr::mutate(buff_radius = ifelse(Type == "subdistrict", km_vec[1], ifelse(Type == "district", km_vec[2], ifelse(Type == "tertiary", km_vec[3], ifelse(Type == "icddr,b", km_vec[4], NA)))))
