...
knit: (function(inputFile, encoding) { 
          rmarkdown::render(inputFile,
                        encoding=encoding, 
                output_file='explore_greyspots_20200617.html') })
---
...
# } else{
  ...
  sero_import <- readRDS("data/entropy-map.rds") %>% ##new one is entropy-map.rds ##old is grid-cell-data-w-entropy.rds
...
We sought to describe how well the cholera surveillance zones capture `r sort(unique(sero2$rr_risk_cat))` populations across Bangladesh. 
